...
timeArray = time.localtime(timeStamp)  # 将时间戳格式化, time.struct_time(tm_year=2022, tm_mon=2, tm_mday=13, tm_hour=16, tm_min=35, tm_sec=14, tm_wday=6, tm_yday=44, tm_isdst=0)
